...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
        ...
        <header id="header" class="fixed">
            ...
            <?php if ( !is_user_logged_in() ) { ?> <span class="fs-medium ml10 mr10"><a href='<?php echo esc_url( home_url( "/login" ) ); ?>'><span class="logo-login"></span>Se connecter</a></span> <?php }
else{ ?>
            <span class="fs-medium ml10 mr10"><a href='<?php echo wp_logout_url("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); ?>'><span class="logo-login"></span>Se déconnecter</a></span>
            <?php } ?>
            </div>
        </header>
